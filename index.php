...
// Keep the $CONFIG on the third line. That's hardcoded because I'm too lazy to properly do it.
/**
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!-- TinyCloudDrive inserted -->
                                        <a href="account.php?web=signup" class="btn btn-primary btn-block w-100 mt-4" role="button">
                                            <?php echo lng('SignUp'); ?>
                                        </a>
                                    </div>
                                </form>
                        ...
                        <div class="footer text-center">
                            ...
                            <!-- TinyCloudDrive inserted -->
                            Account management part by <a href="https://www.zbx1425.cn" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">zbx1425</a>&mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <p>Account management part by Zbx1425</p>
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <!-- TinyCloudDrive inserted -->
                            <?php if (!FM_READONLY && ENABLE_SETTINGS): ?>
